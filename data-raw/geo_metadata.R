...
provCode <- vroom:vroom("https://raw.githubusercontent.com/electorArg/PolAr_Data/master/geo/provCode.csv")

# GET ELECTORAL AND ADMISNITRATIVE CODES (PROVINCIAL AND DEPARTAMENTAL)
dine_indec <- vroom:vroom("https://raw.githubusercontent.com/electorArg/PolAr_Data/master/geo/dine_indec.csv") %>%
...
iso <- vroom:vroom("https://raw.githubusercontent.com/electorArg/PolAr_Data/master/geo/iso_codes.csv") %>%
...
### GET NAMES FOR GRIDS
usethis::use_data(geo_metadata, overwrite = TRUE)
